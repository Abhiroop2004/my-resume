...
def show_projects():
    st.write("### Projects")
    st.write("#### Project 1")
    st.write("- #### Password Management System with Stream Cipher, June 2023")
    ...
    st.write("#### Project 2")
    st.write("- #### IoT based CO2 level monitoring system, April 2023")
    ...
    st.write("#### Project 3")
    st.write("- #### Data Corruption Playground, June 2023")
